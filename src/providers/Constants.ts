export const APK_DOWNLOAD = 'http://125.74.9.49:7769/apk/android-jhzx.apk';// 下载地址
export const APK_ADMIN_DOWNLOAD = 'http://125.74.9.49:7769/apk/android-jhzx-admin.apk';// 下载地址
export const APP_DOWNLOAD = 'http://172.16.19.137:9020/api/';//下载地址
// /*----------------------------------------后台Api地址----------------------------------------*/
