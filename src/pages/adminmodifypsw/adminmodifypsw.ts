...
@IonicPage()
@Component({
  selector: 'page-adminmodifypsw',
  templateUrl: 'adminmodifypsw.html',
})
export class AdminmodifypswPage {
  ...
  constructor(
    ...
    public navParams: NavParams) {
      ...
      this.storageCtrl.get('u_account').then((val) => {
...
postNewPwd() {
  this.appService.httpPost_token(AppGlobal.API.postClientRestPwd, this.u_token, this.FindPwdViewModel, rs => {
    if (rs.isSuccess) {
